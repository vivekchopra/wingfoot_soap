         ...
         implements InteropInterface
{
	...
	{
            com.wingfoot.soap.encoding.Float[] strArray 
            = new com.wingfoot.soap.encoding.Float[] 
	      {new com.wingfoot.soap.encoding.Float("1.23"),
               new com.wingfoot.soap.encoding.Float("4.56")};
	    if (elementMap !=null ||
	        typeMap != null) {
		...
		for (int i=0; elementMap!=null && i<elementMap.size(); i++) {
		    ...
		    if (s[1].trim().equals("array")) {
                          s[1]=new 
                          com.wingfoot.soap.encoding.Float[1].
                          getClass().getName();
		    }
		    if (s[2]==null) {
	    ...
	    call.addParameter("inputFloatArray", strArray);
	    ...
	    Envelope responseEnvelope = call.invoke(transport);
	       ...
	       throw new Exception ("Response envelope is null");
	          ...
	          return "Fault: " + f.getFaultString();
		        ...
		        com.wingfoot.soap.encoding.Float str1 = 
                        (com.wingfoot.soap.encoding.Float) returnString[0];
		         com.wingfoot.soap.encoding.Float str2 = 
                             (com.wingfoot.soap.encoding.Float) returnString[1];
